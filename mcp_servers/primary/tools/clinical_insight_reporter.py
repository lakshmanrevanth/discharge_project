...
def build_report(
    ...
    from shared.tracing.langfuse import ensure_trace_id, get_current_trace_id, trace_url

    tid = ensure_trace_id(patient_id, get_current_trace_id())
